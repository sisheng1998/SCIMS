	...
	return (
		<nav className='flex items-center justify-between'>
			...
			<ul className='flex items-center rounded-lg text-sm font-medium text-gray-500 shadow-sm'>
				<li
					className={`pointer-events-none inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-l-lg border border-gray-200 bg-white transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-500 ${
				...
				{buttons.map((number, index) => (
					<li
						className={`inline-flex h-9 w-9 cursor-pointer items-center justify-center border border-gray-200 bg-white transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-500 ${
							number === currentPage
				...
				<li
					className={`pointer-events-none inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-r-lg border border-gray-200 bg-white transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-500 ${
