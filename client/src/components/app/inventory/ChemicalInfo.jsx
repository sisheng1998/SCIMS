...
const ChemicalInfo = () => {
  ...
  return isLoading ? (
    ...
    <>
      ...
      {!isMobile && isEdit && auth.currentRole >= ROLES_LIST.postgraduate ? (
        <EditChemicalInfo
          chemical={chemical}
          labData={labData}
        ...
        >
          ...
          <ol className='mb-6 ml-4 mt-2 list-decimal space-y-1.5 text-sm'>
            <li>
              ...
              <span className='font-semibold'>get the approval</span> from the
              lab owner.
            </li>
            <li>
              Have at least{' '}
              <span className='font-semibold'>user role of 'Guest'</span> with
              the <span className='font-semibold'>status of 'Active'</span> for
              the lab.
            </li>
          </ol>
